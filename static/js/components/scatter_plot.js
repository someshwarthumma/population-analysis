function draw_scatter_plot(selector, config) {
  ...
  var y = d3.scaleLinear().domain([-y_max, y_max]).range([height, 0]);
  svg.append("g").call(d3.axisLeft(y).ticks(3).tickValues([-y_max, 0, y_max]));
  ...
  svg
    ...
    .style("fill", function (d) {
      return d.continent != null ? color_scale(d.continent) : "red";
    })
